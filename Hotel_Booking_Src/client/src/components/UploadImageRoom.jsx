...
const UploadImageRoom = () => {
  ...
  const handleUpdateRoom = async (e) => {
    ...
    try {
      ...
      formData.append('image', editedRoom.image);
      
      const response = await fetch(`http://localhost:4000/api/v1/room/upload_image/${id}`, {
        method: 'PUT',
        headers: {
          'x-auth-token': token,
        },
