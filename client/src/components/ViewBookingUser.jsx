  ...
  const handleSearch = (term) => {
    ...
    setFilteredData(filtered);
          ...
          const downloadDetails = (booking) => {
            ...
            Hall Details:
            ---------------------------------------------------------
            Hall Name: ${booking.name}
            Hall E-Mail: ${booking.owneremail}
    ...
    <div className="page-content-wrapper">
      <div className="top-products-area py-3">
        ...
        <div className="section-heading d-flex align-items-center justify-content-between">
            <h6>Your Hotel Room booking details</h6>
            ...
            <div className="row" style={{marginTop:10}}>
              ...
              <div className="card product-card" style={{marginBottom:10}}>
                <div className="card-body"    >
                      <a className="product-title d-block"  >Hotel Name :  <b> {booking.name} </b></a>
                      <a className="product-title d-block"  >E-Mail :  <b> {booking.owneremail} </b></a>  
                   
                      <a className="product-title d-block"  >Room Type  :  <b style={{color:'navy'}}> {booking.type} </b></a>
                      <a className="product-title d-block"  >Room Price :  <b style={{color:'navy'}}> {booking.price} </b></a><hr/>
